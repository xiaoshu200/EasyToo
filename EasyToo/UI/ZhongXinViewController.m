...
@interface ZhongXinViewController ()

@end

@implementation ZhongXinViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [self.menuList objectAtIndex:indexPath.section];
    return cell;
}
